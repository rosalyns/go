...
public class Protocol {
	public static class Client {
		 ...
		 * Descriptie: Commando dat verstuurd wordt om te identificeren bij de server
		 * <br>
		 * Content: <code>HALLO_PlayerName_modulesSupported</code>
		 * </p>
		 * 
		 * example: HALLO_Piet_CHAT*SECURITY\n\n modules staan in willekeurige volgorde
		 * gedelimited door standaard delimiter 2
		 *
		 * 
		 */
		 ...
		 * <code>&lt;BoardY&gt;</code> [ <code>&lt;Settings&gt;</code>]]
		 * </p>
		 *
		 * <ul>
		 * <li><code>Opponent Name</code>: <code>String</code> (15) - De naam van de
		 * speler die de invite moet ontvangen.</li>
		 */
		 ...
		 * Accept Invite <br>
		 * Name: <code>ACCEPT\n\n</code> <br>
		 * Descriptie: Packet door de uitgedaagde partij wordt verzonden om op een
		 * invite in te gaan. <br>
		 * Content: <code>&lt;Opponent Name&gt;</code>
		 * </p>
		 *
		 * <ul>
		 * <li><code>Opponent Name</code>: <code>String</code> (15) - De naam van degene
		 * die de uitgedaagde partij heeft uitgedaagd.</li>
		 * </ul>
		 */
		 ...
		 * Decline Invite <br>
		 * Name: <code>DECLINE\n\n</code> <br>
		 * Descriptie: Packet die door de uitgedaagde partij wordt verzonden om een
		 * invite af te slaan. <br>
		 * Content: <code>&lt;Opponent Name&gt;</code>
		 * </p>
		 *
		 * <ul>
		 ...
		 * Descriptie: de steen en locatie combinatie waar de steen neergelegd wordt
		 * <br>
		 * 
		 * <p>
		 ...
		 * </p>
		 * <code>MAKEMOVE_AF*11*6_BF*11*7\n\n<code> Als er meerdere stenen in een beurt
		 * worden gelegd is de de eerste steen de eerste in het commando en de laatste
		 * de laatste in het commando.
		 * 
		 */
		 ...
		 * personen<br>
		 * Content: <code>REQUESTGAME_integer\n\n<code> Valide input voor de integer
		 * zijn: 0: Het maakt je niet uit hoeveel mensen je speelt 1: match tegen een
		 * computerspeler 2: match met 2 personen 3: match met 3 personen 4: match met 4
		 * personen voorbeeld: REQUESTGAME_int\n\n REQUESTGAME_4\n\n
		 */
		 ...
		 * Descriptie: een commando waarmee de hoeveelheid stenen in de zak wordt
		 * gerequest <br>
		 ...
		 * Content: <code>ERROR_integer\n\n</code> er zijn nog geen errors gedefinieerd
		 * voor de speler.
		 */
	...
	public static class Server {
		 ...
		 * HALLO <br>
		 * Name: <code>HALLO</code> <br>
		 * Descriptie: Signaal dat de connectie is gemaakt en het aangeven van welke
		 * functies allemaal zijn toegestaan op deze server. <br>
		 ...
		 * </p>
		 * <ul>
		 * <li><code>Error Code</code>: <code>String</code> - De code is de header van
		 * het bericht waar de fout door is ontstaan.</li>
		 * <li><code>Message</code>: <code>String</code> (255) - Het bericht dat je aan
		 * je error hangt. Hierin kan je extra info tonen over wat er precies is
		 * foutgegaan.</li>
		 * </ul>
		 *
		 ...
		 * Descriptie: Geeft met de integer aan op hoeveel mensen de speler nog moet
		 * wachten tot het spel begint <br>
		 ...
		 * Descriptie: Een packet dat naar de spelers wordt gestuurd om te laten weten
		 * dat het spel gestart is. <br>
		 * Content: <code>START_player_player\n\n</code>]
		 * </p>
		 *
		 * <ul>
		 * <li><code>Player 1</code>: <code>String</code> (15) - Naam van de eerste
		 * speler</li>
		 * <li><code>Player 2</code>: <code>String</code> (15) - Naam van de tweede
		 * speler</li>
		 * </ul>
		 */
		 ...
		 * Descriptie: Een packet dat naar de spelers wordt gestuurd om te laten weten
		 * dat het spel is gestopt en waarom.<br>
		 ...
		 * <li><code>Message</code>: <code>String</code> - Naam van de winnaar, of
		 ...
		 * Descriptie: een commando om aan te geven welke move gemaakt door wie en welke
		 * speler nu aan de beurt is <br>
		 * Content:
		 * <p>
		 ...
		 * Example:
		 * <p>
		 * MOVE_sjaak_piet_AF*11*6_BF*11*7\n\n Er kunnen meerdere moves gemaakt worden,
		 * deze worden gedelimit door standaarddelimiter De charchar worden gescheiden
		 * van de integers met standaarddelimter2 "*". De integers worden van elkaar
		 * gescheiden met standaarddelimiter2 "*" de individuele gelegde stenen worden
		 * gescheiden door standaarddelimter 1 "_" . Als er meerdere stenen in een beurt
		 * worden gelegd is de de eerste steen de eerste in het commando en de laatste
		 * de laatste in het commando.
		 * 
		 */
		 ...
		 * Descriptie: een commando waarmee stenen worden toegevoegd aan de hand van de
		 * speler <br>
		 ...
		 * Leaderboard <br>
		 * Name: <code>LEADERBOARD</code> <br>
		 * Descriptie: Een packet waarin de statistieken van een aantal spelers worden
		 * verstuurd. <br>
		 * Content: <code>LEADERBOARD_playername*integer_playername*integer\n\n</code>
		 * </p>
		 *
		 * <ul>
		 * <li><code>Player Name</code>: <code>String</code> (15) - Naam van de speler
		 * in de betreffende statistiek</li>
		...
		public static class Features {
			...
			/**
			 * <p>
			 * De verschillende features die optioneel zijn geimplementeerd kunnen worden.
			 * </p>
			 *
			 * <p>
			 * Let op! Het protocol voor <code>SECURITY</code> is nog niet vastgelegd. Dit
			 * wordt een SSL certificaat implementatie. Het certificaat wordt later
			 * bijgevoegd aan het protocol op github.
			 */
			public static final String CHAT = "CHAT";
			public static final String LEADERBOARD = "LEADERBOARD";
		 ...
		 * tegenstander</li>
		 * </ul>
		 * op dit moment is er geen mogelijkheid gedefinieerd om meerdere mensen te
		 * challengen
		 */
		...
		public static class Settings {
			...
			/**
			 * <p>
			 * Het protocol heeft characterencoding UTF-16. Dit is de standaard encoding van
			 * een string in java, dus daar zouden geen problemen mee moeten zijn.
			 * </p>
			 */
			...
			/**
			 * <p>
			 * Het aantal seconden voordat een client timeout. Dit is in de opdracht
			 * vastgesteld, en zal dus niet veranderen.
			 * </p>
			 */
			 ...
			 * <b>BELANGRIJK:</b> In de opdracht staat dat je bij het opstarten van de
			 * server een poortnummer moet invoeren. De waarde hier is dus niet een waarde
			 * die altijd opgaat.
			 * </p>
			 */
			...
			/**
			 * <p>
			 * Default delimiter tussen header en content, en tussen twee waarden in de
			 * content
			 * </p>
			 */
			...
			/**
			 * <p>
			 * Teken dat aan het einde van elke packet moet zitten, en dus niet in de rest
			 * van de waarden mag zitten.
			 * </p>
			 */
